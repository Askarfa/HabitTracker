        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TargetStreak = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PredictedCompletionProbability = table.Column<double>(type: "double precision", nullable: false),
                    AvgStreakLength = table.Column<int>(type: "integer", nullable: false),
                    WeeklyCompletionRate = table.Column<double>(type: "double precision", nullable: false),
                    MissedDaysLastMonth = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PredictionModels", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PredictionModels_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PredictionModels_Habits_HabitId",
                        column: x => x.HabitId,
                        principalTable: "Habits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PredictionModels_HabitId",
                table: "PredictionModels",
                column: "HabitId");

            migrationBuilder.CreateIndex(
                name: "IX_PredictionModels_UserId",
                table: "PredictionModels",
                column: "UserId");
        }
